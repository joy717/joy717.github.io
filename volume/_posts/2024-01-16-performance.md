...
# 随机1M读
fio -filename=/dev/emcpowerb -direct=1 -iodepth 1 -thread -rw=randread -ioengine=psync -bs=1M -size=20G -numjobs=50 -runtime=180 -group_reporting -name=rand_100read_4k
# 随机1M写
fio -filename=/dev/emcpowerb -direct=1 -iodepth 1 -thread -rw=randwrite -ioengine=psync -bs=1M -size=20G -numjobs=50 -runtime=180 -group_reporting -name=rand_100write_4k
```
