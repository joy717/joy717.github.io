...
![1](/images/k8s_networking/1.png "1")
...
![Kubernetes Node（root network namespace）](/images/k8s_networking/2.png "Kubernetes Node（root network namespace）")
...
![3](/images/k8s_networking/3.png "3")
...
![Kubernetes Node（linux network bridge）](/images/k8s_networking/4.png "Kubernetes Node（linux network bridge）")
...
![Kubernetes Node（same node pod-to-pod communication）](/images/k8s_networking/5.gif "Kubernetes Node（same node pod-to-pod communication）")
...
![Kubernetes Nodes with route table（cross node pod-to-pod communication）](/images/k8s_networking/6.gif "Kubernetes Nodes with route table（cross node pod-to-pod communication）")
...
![7](/images/k8s_networking/7.png "7")
...
![1](/images/k8s_networking/8.png "1")
...
![Kubernetes Node with route table（cross node pod-to-pop Traffic flow with flannel overlay network）](/images/k8s_networking/9.gif "Kubernetes Node with route table（cross node pod-to-pop Traffic flow with flannel overlay network）")
...
![Packet-in-packet encapsulation（notice the packet is encapsulated from 3c to 6b in previous diagram）](/images/k8s_networking/10.png "Packet-in-packet encapsulation（notice the packet is encapsulated from 3c to 6b in previous diagram）")
